#ifndef WBR_MODEL_SIMULATE_WBR_CONTROLLER_V2_COMMON_CONTROLLER_CONFIG_H_
#define WBR_MODEL_SIMULATE_WBR_CONTROLLER_V2_COMMON_CONTROLLER_CONFIG_H_
...
// Yaw loop and identified yaw/leg-split decoupling.
...
// State estimation and contact handling.
...
// Differential leg-angle control.
...
inline constexpr double kLegSplitSoftAngle = 0.08;
inline constexpr double kLegSplitHardAngle = 0.25;
inline constexpr double kLegSplitSoftRate = 0.25;
inline constexpr double kLegSplitHardRate = 1.0;
...
inline constexpr double kYawRollSoftLimit = 0.08;
inline constexpr double kYawRollHardLimit = 0.20;
...
inline constexpr double kYawTorqueMarginHard = 0.20;
inline constexpr double kYawTorqueMarginSoft = 1.0;
...
#endif  // WBR_MODEL_SIMULATE_WBR_CONTROLLER_V2_COMMON_CONTROLLER_CONFIG_H_
